        ...
        try {
            final response = await http.post(
                ...
                body: jsonEncode({
                    'contents': [{
                        'parts': [{
                            'text': 'You are a waste sorting assistant. For the food item or packaging: "$item", respond ONLY with a JSON object in this exact format: {"category": "compost" or "recycle" or "landfill", "reason": "one sentence explanation", "tip": "one practical tip"}'
                        }]
                    }]
                }),
            );
                                        ...
                                        ElevatedButton(
                                            ...
                                            const SizedBox(
                                                ...
                                                child: CircularProgressIndicator(
                                                    strokeWidth: 2, color: Colors.white)): Text('check', style: GoogleFonts.poppins()),
                                        ),
                                                                                    ...
                                                                                    child: Row(
                                                                                        children: [
                                                                                            const Icon(Icons.lightbulb_outline,
                                                                                                    color: Color(0xFFbc6c25), size: 18),
